...
while True:
    ...
    # Prevent message from displaying indefinitely
    if ballRect.colliderect(targetRect) and printMessage:
        print('Ball is touching the target')
        printMessage = False
    # Allow message to be printed again after ball leaves target
