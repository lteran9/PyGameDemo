...
while True:
    ...
    if keyPressedTuple[pygame.K_LEFT] or keyPressedTuple[pygame.K_a]:  # moving left
        ballX = ballX - N_PIXELS_TO_MOVE

    if keyPressedTuple[pygame.K_RIGHT] or keyPressedTuple[pygame.K_d]:  # moving right
        ballX = ballX + N_PIXELS_TO_MOVE

    if keyPressedTuple[pygame.K_UP] or keyPressedTuple[pygame.K_w]:  # moving up
        ballY = ballY - N_PIXELS_TO_MOVE

    if keyPressedTuple[pygame.K_DOWN] or keyPressedTuple[pygame.K_s]:  # moving down
        ballY = ballY + N_PIXELS_TO_MOVE            
