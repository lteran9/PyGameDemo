...
while True:
    ...
    pygame.draw.line(window, RED, (20, 20), (60, 60), 2)
    pygame.draw.line(window, RED, (20, 60), (60, 20), 2)
    ...
    # Draw a filled rectangle and a super-imposed empty rectangle
    pygame.draw.rect(window, RED, (250, 150, 100, 50), 0)  # filled
    pygame.draw.rect(window, RED, (225, 125, 150, 100), 1)  # 1 pixel edge
    ...
    pygame.draw.polygon(window, PURPLE, ((240, 350), (350, 350),
    ...
    pygame.draw.aalines(window, BLUE, True, ((580, 400),
                        (587, 450), (595, 460), (600, 444)))
